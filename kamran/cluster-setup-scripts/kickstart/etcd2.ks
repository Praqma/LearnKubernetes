...
# Network information
network  --bootproto=static --device=ens3 --gateway=10.240.0.1 --ip=10.240.0.12 --nameserver=10.240.0.1 --netmask=255.255.255.0 --noipv6 --activate
network  --hostname=etcd2.example.com
